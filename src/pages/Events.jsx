 ...
 *
 * v24 변경 (2026-05-01, 트랙 E 3 — 사용자 catch):
 *  - 🆕 이용 안내 5줄 ul 불릿 패턴 (PC↔모바일 cross-promotion).
 *    PC 설치 안내, 동기화, 카테고리 PC-only, 쿠팡 disclaimer.
 *
 * v23 (제거): <p> + <br> 안내문.
 * v22 (유지): CategoryHeader 폰트 11px.
 * ========================================================= */
      ...
      <section>
        ...
        <ul
          ...
          style={{
            ...
            color: "#A8A699",
            paddingTop: "6px",
            paddingLeft: "32px", // 16 (px-4) + 12 (불릿 들여쓰기)
            listStyleType: "disc",
